...
def bridge_geom(default, coords, z):
    ...
    bridge_center_offset_upper = 2
    bridge_center_offset_lower = 1
    ml = 10.
    offset_ul = center.parallel_offset(bridge_center_offset_upper, 'left', resolution=16, join_style=2, mitre_limit=ml)
    offset_ur = center.parallel_offset(bridge_center_offset_upper, 'right', resolution=16, join_style=2, mitre_limit=ml)
    offset_ll = center.parallel_offset(bridge_center_offset_lower, 'left', resolution=16, join_style=2, mitre_limit=ml)
    offset_lr = center.parallel_offset(bridge_center_offset_lower, 'right', resolution=16, join_style=2, mitre_limit=ml)
    # -- plot
    plt.figure()
